...
**Threshold Hysteresis in Dynamic Acquire-Divest Decisions with Transaction Costs**

## Purpose

The manuscript is theoretical and does not require external empirical data. This replication package regenerates the numerical illustration reported in main-text Tables 2-6, Supplementary Table S1, and the partial prerequisite-loop trace discussed in Section 5.6.
...
All values are illustrative and are stated in the manuscript or in Supplementary Table S1. The package is intended to increase transparency and auditability; it is not a separate empirical validation study.
